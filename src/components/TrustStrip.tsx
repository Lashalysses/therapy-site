const items = [
  ...
  },
  {
    ...
    label: "Postgraduate Trained",
    detail: "Multiple modalities",
  },
  {
    icon: (
      <svg width="28" height="28" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
    ...
    detail: "GDPR compliant practice",
  },
];

export default function TrustStrip() {
  return (
    <section className="bg-white border-y border-warm-border py-10">
